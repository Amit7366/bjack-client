  ...
  return (
    <>
      ...
      <div className="space-y-3 text-[11px] leading-[1.7] text-[#6b7280]">
        <p>
          <span className="text-[#4ade80]">raja1.online</span> {b.legalOwnership}
        </p>
        <p>
        ...
        <p>
          <span className="text-[#4ade80]">raja1.online</span> {b.legalLicense}
        </p>
        <p>
          <span className="text-[#4ade80]">raja1.online</span> {b.legalCompliance}
        </p>
      </div>
    </>
  );
