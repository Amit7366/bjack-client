...
const bn: ReferralRulesMessages = {
  ...
  otherTermsItems: [
    "যদি অ্যাকাউন্টের ব্যাপারে কোন প্রকার অপব্যবহারের সন্দেহ হয় এবং / অথবা প্রাপ্ত সুবিধাটি মেনে না নেয় তবে banglajackpot বোনাস বাতিলের অধিকার সংরক্ষণ করে।",
    "যে কোনও সময় এই প্রমোশন থেকে যে কোনও প্লেয়ারকে বাদ দিতে এবং কোনও ব্যাখ্যা না দিয়ে পরিবর্তন, সংশোধন, এবং / অথবা কোনও বোনাস অফার বা প্রমোশন বাতিল করার অধিকার banglajackpot সংরক্ষণ করে।",
    "banglajackpot-র সাধারণ নীতিমালা এবং শর্তাদি প্রযোজ্য।",
  ],
};
...
const en: ReferralRulesMessages = {
  ...
  otherTermsItems: [
    "banglajackpot reserves the right to cancel the bonus if there is any suspicion of account abuse and/or if the benefit received is not accepted.",
    "banglajackpot reserves the right to exclude any player from this promotion at any time and to change, amend, and/or cancel any bonus offer or promotion without explanation.",
    "banglajackpot's general terms and conditions apply.",
  ],
};
