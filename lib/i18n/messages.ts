...
const en: Messages = {
  ...
  viewAll: "View all",
  gameLoginPrompt: {
    title: "Become a banglajackpot Member",
    description: "Log in to play the game. If you don't have an account, sign up for free!",
    close: "Close",
  },
  appDownloadPrompt: {
    title: "Download the banglajackpot app now and enjoy the best gaming experience.",
  ...
  home: {
    announcement:
      "Download our official app: https://banglajackpot.online/download/banglajackpot/banglajackpot.apk — Dear customers, please use the given link to access our website and enjoy uninterrupted service.",
    slides: [
      {
        brand: "JILI",
        code: "JILIGIFT",
...
const bn: Messages = {
  ...
  viewAll: "সব দেখুন",
  gameLoginPrompt: {
    title: "একজন banglajackpot সদস্য হন",
    description: "গেমটি খেলতে লগ ইন করুন। আপনার যদি অ্যাকাউন্ট না থাকে তবে ফ্রি সাইন আপ করুন!",
    close: "বন্ধ করুন",
  },
  appDownloadPrompt: {
    title: "এখনই banglajackpot অ্যাপ ডাউনলোড করুন, সর্বোচ্চ পুরস্কার জিতুন।",
  ...
  home: {
    announcement:
      "আমাদের অফিসিয়াল অ্যাপ ডাউনলোড করুন: https://banglajackpot.online/download/banglajackpot/banglajackpot.apk — প্রিয় গ্রাহক, আমাদের ওয়েবসাইটে অবিচ্ছিন্ন সেবা পেতে দেওয়া লিংক ব্যবহার করুন।",
    slides: [
      {
        brand: "JILI",
        code: "JILIGIFT",
...
const hi: Messages = {
  ...
  viewAll: "सभी देखें",
  gameLoginPrompt: {
    title: "banglajackpot सदस्य बनें",
    description: "गेम खेलने के लिए लॉग इन करें। अकाउंट नहीं है तो मुफ्त में साइन अप करें!",
    close: "बंद करें",
  },
  appDownloadPrompt: {
    title: "अभी banglajackpot ऐप डाउनलोड करें और बेहतरीन गेमिंग अनुभव पाएं।",
  ...
  home: {
    announcement:
      "हमारा आधिकारिक ऐप डाउनलोड करें: https://banglajackpot.online/download/banglajackpot/banglajackpot.apk — प्रिय ग्राहक, निर्बाध सेवा के लिए दिए गए लिंक का उपयोग करें।",
    slides: [
      {
        brand: "JILI",
        code: "JILIGIFT",
